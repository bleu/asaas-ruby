...
module Asaas
  ...
  # represent a customer's payment instrument, and can be used with the Asaas API
  # just like a `Card` object: once chargeable, they can be charged, or can be
  # attached to customers.
  #
  # Asaas doesn't recommend using the deprecated [Sources API](https://asaas.com/docs/api/sources).
  # We recommend that you adopt the [PaymentMethods API](https://asaas.com/docs/api/payment_methods).
  # This newer API provides access to our latest features and payment method types.
  #
  # Related guides: [Sources API](https://asaas.com/docs/sources) and [Sources & Customers](https://asaas.com/docs/sources/customers).
