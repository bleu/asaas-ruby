...
module Asaas
  ...
  # [multiple statuses](https://asaas.com/docs/payments/intents#intent-statuses)
  # throughout its lifetime as it interfaces with Asaas.js to perform
  # authentication flows and ultimately creates at most one successful charge.
  #
  # Related guide: [Payment Intents API](https://asaas.com/docs/payments/payment-intents)
