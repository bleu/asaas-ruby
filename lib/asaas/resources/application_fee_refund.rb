...
module Asaas
  ...
  # the Asaas account from which the fee was originally collected.
  #
  # Related guide: [Refunding application fees](https://asaas.com/docs/connect/destination-charges#refunding-app-fee)
