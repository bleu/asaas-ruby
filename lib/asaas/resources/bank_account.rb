...
module Asaas
  ...
  #
  # On the other hand [External Accounts](https://asaas.com/docs/api#external_accounts) are transfer
  # destinations on `Account` objects for [Custom accounts](https://asaas.com/docs/connect/custom-accounts).
  # They can be bank accounts or debit cards as well, and are documented in the links above.
  #
  # Related guide: [Bank debits and transfers](https://asaas.com/docs/payments/bank-debits-transfers)
