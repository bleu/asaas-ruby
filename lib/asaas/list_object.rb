...
module Asaas
  class ListObject < AsaasObject
    include Enumerable
    include Asaas::APIOperations::List
    include Asaas::APIOperations::Request
    include Asaas::APIOperations::Create
    ...
    #
    # The default iteration direction is forwards according to Asaas's API
    ...
    def retrieve(id, opts = {})
      ...
      Util.convert_to_asaas_object(resp.data, opts)
    end
